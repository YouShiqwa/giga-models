...
train_config="configs.pi05_robocasa_set_up_cutting_station_dual_16query_action.config"
checkpoint="${project_dir}/experiments/vla/pi05/robocasa_set_up_cutting_station_dual_16query_action/models/checkpoint_epoch_10_step_50000/model_ema"
eval_launcher="${openpi_root}/examples/robocasa/eval_giga_dual_query_action_robocasa.sh"
eval_config="${openpi_root}/examples/robocasa/configs/giga_pi05_dual_16query_action.yaml"
...
if [[ ! -f "${project_dir}/configs/pi05_robocasa_set_up_cutting_station_dual_16query_action.py" ]]; then
...
log "Starting Pi0.5-initialized dual_16query_action training"
cd "${project_dir}"
